#! /usr/bin/env python
"""
Created on Thu Aug 14 09:39:50 2014
...
# Rauschmessung
data1 = Praktikum.lese_lab_datei('lab/Thermo_Rauschmessung.lab')
...
data2 = Praktikum.lese_lab_datei('lab/Thermo_Hauptmessung.lab')
p = data2[:,2]
T = data2[:,3]
...
T2, p2 = Praktikum.untermenge_daten(T,p,1./0.00284,1./0.00272)
logP2 = np.log(p2/p0)
Tinv2 = 1.0/T2
...
a,ea,b,eb,chiq,corr = \
        Praktikum.lineare_regression_xy(Tinv2,logP2,sigma_Tinv2,sigma_logP2)
