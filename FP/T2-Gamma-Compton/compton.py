...
fig, ax = plt.subplots()
ax.errorbar(real_angle[0:5], E[0:5], fmt='b.', xerr=real_dangle[0:5], yerr=dE[0:5], label='Ring geometry')
ax.errorbar(real_angle[5:11], E[5:11], fmt='g.', xerr=real_dangle[5:11], yerr=dE[5:11], label='Conventional geometry, Al cylinder')
ax.errorbar(real_angle[11:17], E[11:17], fmt='m.', xerr=real_dangle[11:17], yerr=dE[11:17], label='Conventional geometry, Fe cylinder')
ax.plot(real_angle[0:5], unp.nominal_values(theo1[0:5]), 'r-', label='Theory prediction with error margin')
ax.plot(real_angle[0:5], unp.nominal_values(theo1[0:5])+unp.std_devs(theo1[0:5]), 'r--')
ax.plot(real_angle[0:5], unp.nominal_values(theo1[0:5])-unp.std_devs(theo1[0:5]), 'r--')
ax.plot(real_angle[5:11], unp.nominal_values(theo1[5:11]), 'r-')
ax.plot(real_angle[5:11], unp.nominal_values(theo1[5:11])+unp.std_devs(theo1[5:11]), 'r--')
ax.plot(real_angle[5:11], unp.nominal_values(theo1[5:11])-unp.std_devs(theo1[5:11]), 'r--')
...
np.savetxt('photo_peaks_2_new.NORM',[real_angle,real_dangle,mean,dmean,sig,dsig])
