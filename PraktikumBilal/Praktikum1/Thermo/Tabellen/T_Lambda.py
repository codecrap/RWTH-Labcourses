...
if __name__ == '__main__':
    ...
    with doc.create(Tabular('c|c|c')) as table:
        table.add_row(('Abschnitt','T in K', 'lambda in ',))
        table.add_hline()
        table.add_row((1,a[0], b[0]))
        table.add_row((2,a[1], b[1]))
        table.add_row((3,a[2], b[2]))
        table.add_row((4,a[3], b[3]))
        table.add_row((5,a[4], b[4]))
        table.add_row((6,a[5], b[5]))
        table.add_row((7,a[6], b[6]))
        table.add_row((8,a[7], b[7]))
        table.add_row((9,a[8], b[8]))
        table.add_row((10,a[9], b[9]))
        table.add_row((11, a[10], b[10]))
        table.add_row((12, a[11], b[11]))
        table.add_row((13, a[12], b[12]))
        table.add_row(( 14,a[13], b[13]))
        table.add_row(( 15,a[14], b[14]))
        table.add_row(( 16,a[15], b[15]))
        table.add_row(( 17,a[16], b[16]))
        table.add_row(( 18,a[17], b[17]))
        table.add_row(( 19,a[18], b[18]))
        table.add_row(( 20,a[19], b[19]))
        table.add_row(( 21,a[20], b[20]))
...
if __name__ == '__main__':
    ...
    with doc.create(Tabular('c|c|c')) as table:
        table.add_row(('Abschnitt','T in K', 'lambda in ',))
        table.add_hline()
        table.add_row((1,c[0], d[0]))
        table.add_row((2,c[1], d[1]))
        table.add_row((3,c[2], d[2]))
        table.add_row((4,c[3], d[3]))
        table.add_row((5,c[4], d[4]))
        table.add_row((6,c[5], d[5]))
        table.add_row((7,c[6], d[6]))
        table.add_row((8,c[7], d[7]))
        table.add_row((9,c[8], d[8]))
        table.add_row((10,c[9], d[9]))
